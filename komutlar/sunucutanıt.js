...
exports.run = async (client, message, args) => {
  ...
  .setAuthor('Cheeis Preminum BOT', client.user.avatarURL)
  .setTitle('Cheeis Preminum', client.user.avatarURL)
  .setURL("https://discord.gg/YyfNEf8")
  .setDescription("-sunucutanıt Kullandınız.")
  .addField('Sizin Sunucunuz Burada Tanıtıldı', `[Tıkla](https://discord.gg/hqcdc6RATJ)`)
        .setTimestamp()
 ...
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setAuthor('Cheeis Preminum BOT', client.user.avatarURL)
      .setTitle('Cheeis Preminum', client.user.avatarURL)
      .setURL("https://discord.gg/hqcdc6RATJ")
